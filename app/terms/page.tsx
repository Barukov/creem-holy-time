...
const sections = [
  ...
  {
    title: "10. Support",
    text: "For product access, delivery, refund, or account questions, contact us through the Contact page or at support@holytime.store. We may ask for your checkout email or order details to locate your purchase.",
  },
  {
