...
const products = [
  ...
  ["product199", "Elite Trading Pack", "€199", "Advanced learning materials, technical study guides and structured educational resources."],
      ...
      <header className="bg-[#13083d] px-8 py-8 text-white">
        <div className="mx-auto flex max-w-7xl items-center justify-between">
          ...
          <div className="flex items-center gap-4">
            ...
            <Link href="/contact" className="font-bold">Support</Link>
      ...
      <section className="mx-auto max-w-7xl px-8 py-24">
        <div className="mb-12 max-w-3xl">
          ...
          <p className="mt-6 text-lg leading-8 text-black/60">
            ...
            confirmation. For support, contact support@creem-holy-time.auction.
          </p>
        </div>
